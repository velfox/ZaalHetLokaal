...
-- Dumpen data van tabel zaalhetlokaal.persoon: ~14 rows (ongeveer)
...
INSERT INTO `persoon` (`id`, `naam`, `achternaam`, `email`, `tel`, `aangemaakt`) VALUES
	...
	(151, 'Mickey', 'Mouse', '0', 0, '2019-01-16 15:34:34');
...
-- Dumpen data van tabel zaalhetlokaal.reservering: ~14 rows (ongeveer)
...
INSERT INTO `reservering` (`id`, `aangemaakt`, `dagdeelm`, `dagdeelo`, `dagdeela`, `accepted`, `personen`, `dag`, `arragement`, `persoon_id`) VALUES
	...
	(170, '2019-01-16 15:34:34', 1, 1, 0, 0, 34, '2019-01-10', 'bbq', 151);

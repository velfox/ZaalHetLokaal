...
try {
    ...
    $mail->Host       = 'smtp02.hostnet.nl';                // Specify main and backup SMTP servers
    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    $mail->Username   = 'geenantwoord@zaalhetlokaal.nl';        // SMTP username
    $mail->Password   = 'hacker34kamerik';                         // SMTP password
    ...
    $mail->Body    = " <div class='email-background' style='background-color:#998675;padding-top:15px;padding-bottom:15px;padding-right:0px;padding-left:0px;' >
            ...
            <div class='email-container' style='max-width:800px;background-color:#C7B299;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;' >
                    <div class='text' style='background-color:#FAFAFA;padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;color:#212121;' > Beste $name, <br> <br> Uw bericht is ontvangen <br> Wij streven er naar om uw binnen 2 werkdagen een reactie te sturen.</div>
            </div>
